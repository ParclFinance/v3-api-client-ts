 ...
 * 
 * @export
 * @interface ModifyPositionPayload
 */
export interface ModifyPositionPayload {
     ...
     * @type {string}
     * @memberof ModifyPositionPayload
     */
...
/**
 * Check if a given object implements the ModifyPositionPayload interface.
 */
export function instanceOfModifyPositionPayload(value: object): value is ModifyPositionPayload {
...
export function ModifyPositionPayloadFromJSON(json: any): ModifyPositionPayload {
    return ModifyPositionPayloadFromJSONTyped(json, false);
}

export function ModifyPositionPayloadFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModifyPositionPayload {
    if (json == null) {
        return json;
    }
    return {
...
export function ModifyPositionPayloadToJSON(value?: ModifyPositionPayload | null): any {
    if (value == null) {
        return value;
    }
    return {
