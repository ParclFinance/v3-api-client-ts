 ...
 * @export
 */
export type MarketIdentifier = number | string;

export function MarketIdentifierFromJSON(json: any): MarketIdentifier {
    return MarketIdentifierFromJSONTyped(json, false);
}

export function MarketIdentifierFromJSONTyped(json: any, ignoreDiscriminator: boolean): MarketIdentifier {
    if (json == null) {
        return json;
    }
...
export function MarketIdentifierToJSON(value?: MarketIdentifier | null): any {
    if (value == null) {
        return value;
    }
